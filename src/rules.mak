...
OBJDIRS += $(OBJ_CPU)/z80
CPUDEFS += -DHAS_Z80=1
CPUOBJS += $(OBJ_CPU)/z80/z80.o
DBGOBJS += $(OBJ_CPU)/z80/z80dasm.o
#$(OBJ_CPU)/z80/z80.o: z80.c z80.h
else
CPUDEFS += -DHAS_Z80=0
endif
