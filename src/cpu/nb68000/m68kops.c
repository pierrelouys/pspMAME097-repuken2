...
OP(m68k_op_abcd_8_rr)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = DY;
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = LOW_NIBBLE(src) + LOW_NIBBLE(dst) + XFLAG_AS_1();
...
OP(m68k_op_abcd_8_mm_ax7)
{
	TEMP_UINT32 /*uint*/src = OPER_AY_PD_8();
	TEMP_UINT32 /*uint*/ea	= EA_A7_PD_8();
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = LOW_NIBBLE(src) + LOW_NIBBLE(dst) + XFLAG_AS_1();
...
OP(m68k_op_abcd_8_mm_ay7)
{
	TEMP_UINT32 /*uint*/src = OPER_A7_PD_8();
	TEMP_UINT32 /*uint*/ea	= EA_AX_PD_8();
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = LOW_NIBBLE(src) + LOW_NIBBLE(dst) + XFLAG_AS_1();
...
OP(m68k_op_add_8_er_d)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_ai)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_AI_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_pi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_PI_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_pi7)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_A7_PI_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_di)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_DI_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_ix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_IX_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_aw)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AW_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_al)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AL_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_pcdi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_PCDI_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_pcix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_PCIX_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_er_i)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_d)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DY);
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_a)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(AY);
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_ai)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_AI_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_pi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_PI_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_pd)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_PD_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_di)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_DI_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_ix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_IX_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_aw)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AW_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_al)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AL_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_pcdi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_PCDI_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_pcix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_PCIX_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_er_i)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_a)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = AY;
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_ai)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_AI_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_pi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_PI_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_pd)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_PD_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_di)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_DI_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_ix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AY_IX_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_aw)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AW_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_al)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_AL_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_pcdi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_PCDI_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_pcix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_PCIX_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_er_i)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_re_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_8();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_re_pi)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_PI_8();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_re_pi7)
{
	TEMP_UINT32 /*uint*/ea = EA_A7_PI_8();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_re_pd)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_PD_8();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_re_di)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_DI_8();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_re_ix)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_IX_8();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_re_aw)
{
	TEMP_UINT32 /*uint*/ea = EA_AW_8();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_8_re_al)
{
	TEMP_UINT32 /*uint*/ea = EA_AL_8();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_re_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_re_pi)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_PI_16();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_re_pd)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_PD_16();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_re_di)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_DI_16();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_re_ix)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_IX_16();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_re_aw)
{
	TEMP_UINT32 /*uint*/ea = EA_AW_16();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_16_re_al)
{
	TEMP_UINT32 /*uint*/ea = EA_AL_16();
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DX);
	TEMP_UINT32 /*uint*/dst = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_re_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_32();
	TEMP_UINT32 /*uint*/src = DX;
	TEMP_UINT32 /*uint*/dst = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_re_pi)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_PI_32();
	TEMP_UINT32 /*uint*/src = DX;
	TEMP_UINT32 /*uint*/dst = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_re_pd)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_PD_32();
	TEMP_UINT32 /*uint*/src = DX;
	TEMP_UINT32 /*uint*/dst = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_re_di)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_DI_32();
	TEMP_UINT32 /*uint*/src = DX;
	TEMP_UINT32 /*uint*/dst = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_re_ix)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_IX_32();
	TEMP_UINT32 /*uint*/src = DX;
	TEMP_UINT32 /*uint*/dst = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_re_aw)
{
	TEMP_UINT32 /*uint*/ea = EA_AW_32();
	TEMP_UINT32 /*uint*/src = DX;
	TEMP_UINT32 /*uint*/dst = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_add_32_re_al)
{
	TEMP_UINT32 /*uint*/ea = EA_AL_32();
	TEMP_UINT32 /*uint*/src = DX;
	TEMP_UINT32 /*uint*/dst = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = src + dst;
...
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/src = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst;
...
OP(m68k_op_addx_8_rr)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src + dst + XFLAG_AS_1();
...
OP(m68k_op_addx_16_mm)
{
	TEMP_UINT32 /*uint*/src = OPER_AY_PD_16();
	TEMP_UINT32 /*uint*/ea	= EA_AX_PD_16();
	TEMP_UINT32 /*uint*/dst = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src + dst + XFLAG_AS_1();
...
OP(m68k_op_addx_32_mm)
{
	TEMP_UINT32 /*uint*/src = OPER_AY_PD_32();
	TEMP_UINT32 /*uint*/ea	= EA_AX_PD_32();
	TEMP_UINT32 /*uint*/dst = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = src + dst + XFLAG_AS_1();
...
OP(m68k_op_and_8_re_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_8();
	TEMP_UINT32 /*uint*/res = DX & m68ki_read_8(ea);
...
OP(m68k_op_and_16_re_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/res = DX & m68ki_read_16(ea);
...
OP(m68k_op_and_32_re_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_32();
	TEMP_UINT32 /*uint*/res = DX & m68ki_read_32(ea);
...
OP(m68k_op_andi_8_ai)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_8();
	TEMP_UINT32 /*uint*/res = src & m68ki_read_8(ea);
...
OP(m68k_op_andi_16_ai)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/res = src & m68ki_read_16(ea);
...
OP(m68k_op_andi_32_ai)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_32();
	TEMP_UINT32 /*uint*/res = src & m68ki_read_32(ea);
...
OP(m68k_op_asr_8_s)
{
	...
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = src >> shift;
	...
	if(shift != 0)
	{
		...
		if(GET_MSB_8(src))
		{
			...
			#else
			res |= (UINT32)((((INT32)0x80000000) >> (shift + 24-1)) & 0xff);
			#endif
		}
	}
	*r_dst = MASK_OUT_BELOW_8(*r_dst) | res;
...
OP(m68k_op_asr_16_s)
{
	uint* r_dst = &DY;
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = src >> shift;
	...
	if(shift != 0)
	{
		...
		#else
			res |= (UINT32)((((INT32)0x80000000) >> (shift + 16-1)) & 0xffff);
		#endif
		}
	}
	*r_dst = MASK_OUT_BELOW_16(*r_dst) | res;
...
OP(m68k_op_asr_32_s)
{
	...
	if(shift != 0)
	{
		...
		#else
			res |= (UINT32)((((INT32)0x80000000) >> (shift + 0-1)));
		#endif
		}
	}
	*r_dst = res;
	...
	if(shift != 0)
	{
		...
		TEMP_UINT32 /*uint*/res = src >> shift;
			...
			*r_dst = MASK_OUT_BELOW_8(*r_dst) | res;
			...
			FLAG_Z = res;
			FLAG_V = VFLAG_CLEAR;
			RET_0_;//goto my_ret_asr8r;//return;
		}//else
		{
			if(GET_MSB_8(src))
			{
	...
	if(shift != 0)
	{
		...
		TEMP_UINT32 /*uint*/res = src >> shift;
			...
			*r_dst = MASK_OUT_BELOW_16(*r_dst) | res;
			...
			FLAG_Z = res;
			FLAG_V = VFLAG_CLEAR;
			RET_0_;//goto my_ret_asr16r;//return;
		}//else
		{
			if(GET_MSB_16(src))
			{
	...
	if(shift != 0)
	{
		...
		TEMP_UINT32 /*uint*/res = src >> shift;
			...
			*r_dst = res;
			...
			FLAG_Z = res;
			FLAG_V = VFLAG_CLEAR;
			RET_0_;//goto my_ret_asr32r;//return;
		}
...
OP(m68k_op_asr_16_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/src = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = src >> 1;
...
OP(m68k_op_asl_8_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(src << shift);
	...
	*r_dst = MASK_OUT_BELOW_8(*r_dst) | res;
	...
	#else
	{
	//	UINT32 msk = m68ki_shift_8_table[shift + 1];
		UINT32 msk = (((INT32)0x80000000) >> (shift + 24)) & 0xff;
		src &= msk;
		FLAG_V = (!(src == 0 || (src == msk && shift < 8)))<<7;
	}
	#endif
	RET_0_;//return;
}
...
OP(m68k_op_asl_16_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(src << shift);
	...
	*r_dst = MASK_OUT_BELOW_16(*r_dst) | res;
	...
	#else
	{
	//	UINT32 msk = m68ki_shift_16_table[shift + 1];
		UINT32 msk = (((INT32)0x80000000) >> (shift + 16)) & 0xffff;
		src &= msk;
		FLAG_V = (!(src == 0 || src == msk))<<7;
	}
	#endif
	RET_0_;//return;
}
...
OP(m68k_op_asl_32_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = *r_dst;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(src << shift);
...
//	FLAG_V = (!(src == 0 || src == m68ki_shift_32_table[shift + 1]))<<7;
	{
	//	UINT32 msk = m68ki_shift_32_table[shift + 1];
		UINT32 msk = (((INT32)0x80000000) >> (shift + 0));
		src &= msk;
		FLAG_V = (!(src == 0 || src == msk))<<7;
	}
	RET_0_;//return;
...
OP(m68k_op_asl_8_r)
{
	...
	if(shift != 0)
	{
		...
		//	FLAG_V = (!(src == 0 || src == m68ki_shift_8_table[shift + 1]))<<7;
			...
			RET_0_;//goto my_ret_asl8r;//return;
		}//else
		{
			*r_dst &= 0xffffff00;
...
OP(m68k_op_asl_16_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/src = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(src << 1);
...
OP(m68k_op_bchg_8_r_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_8();
	TEMP_UINT32 /*uint*/src = m68ki_read_8(ea);
	uint mask = 1 << (DX & 7);
...
{
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(DX);
	TEMP_UINT32 /*uint*/res = dst - src;
...
{
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(DY);
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(DX);
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_d)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(DY);
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_a)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(AY);
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_ai)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_AY_AI_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_pi)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_AY_PI_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_pd)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_AY_PD_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_di)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_AY_DI_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_ix)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_AY_IX_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_aw)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_AW_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_al)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_AL_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_pcdi)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_PCDI_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_pcix)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_PCIX_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpa_16_i)
{
	TEMP_UINT32 /*uint*/src = MAKE_INT_16(OPER_I_16());
	TEMP_UINT32 /*uint*/dst = AX;
	TEMP_UINT32 /*uint*/res = dst - src;
...
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_ai)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_AY_AI_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_pi)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_AY_PI_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_pi7)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_A7_PI_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_pd)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_AY_PD_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_pd7)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_A7_PD_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_di)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_AY_DI_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_ix)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_AY_IX_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_aw)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_AW_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_8_al)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/dst = OPER_AL_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_16_d)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_16(DY);
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_16_ai)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = OPER_AY_AI_16();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_16_pi)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = OPER_AY_PI_16();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_16_pd)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = OPER_AY_PD_16();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_16_di)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = OPER_AY_DI_16();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_16_ix)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = OPER_AY_IX_16();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_16_aw)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = OPER_AW_16();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_16_al)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/dst = OPER_AL_16();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_32_d)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = DY;
	TEMP_UINT32 /*uint*/res = dst - src;
#if (1==M68K_USE_SYS16_CALLBACK)
	#if (OPT_ON==M68K_FD1094_TYPE)
	/* hack */
	if (0==(REG_IR & 7))
	{
		if (0x0000ffff == (src & 0x0000ffff)) // ?
		{
			m68ki_cmpild_callback((src>>16), 0/*dummy*/);		 /* auto-disable (see m68kcpu.h) */
		}
	}
	#else
	/* compatibles */
...
OP(m68k_op_cmpi_32_ai)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = OPER_AY_AI_32();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_32_pi)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = OPER_AY_PI_32();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_32_pd)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = OPER_AY_PD_32();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_32_di)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = OPER_AY_DI_32();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_32_ix)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = OPER_AY_IX_32();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_32_aw)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = OPER_AW_32();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpi_32_al)
{
	TEMP_UINT32 /*uint*/src = OPER_I_32();
	TEMP_UINT32 /*uint*/dst = OPER_AL_32();
	TEMP_UINT32 /*uint*/res = dst - src;
...
OP(m68k_op_cmpm_8_ay7)
{
	TEMP_UINT32 /*uint*/src = OPER_A7_PI_8();
	TEMP_UINT32 /*uint*/dst = OPER_AX_PI_8();
	TEMP_UINT32 /*uint*/res = dst - src;
...
{
	TEMP_UINT32 /*uint*/src = OPER_AY_PI_16();
	TEMP_UINT32 /*uint*/dst = OPER_AX_PI_16();
	TEMP_UINT32 /*uint*/res = dst - src;
...
{
	TEMP_UINT32 /*uint*/src = OPER_AY_PI_32();
	TEMP_UINT32 /*uint*/dst = OPER_AX_PI_32();
	TEMP_UINT32 /*uint*/res = dst - src;
...
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(*r_dst - 1);
...
OP(m68k_op_divs_16_d)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(DY);
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
			FLAG_Z = 0;
			FLAG_N = NFLAG_CLEAR;
			FLAG_V = VFLAG_CLEAR;
		...
		{
		sint quotient  = MAKE_INT_32(*r_dst) / ssrc;
		sint remainder = MAKE_INT_32(*r_dst) % ssrc;
...
OP(m68k_op_divs_16_ai)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_AY_AI_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_pi)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_AY_PI_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_pd)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_AY_PD_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_di)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_AY_DI_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_ix)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_AY_IX_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_aw)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_AW_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_al)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_AL_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_pcdi)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_PCDI_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_pcix)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_PCIX_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_divs_16_i)
{
	uint* r_dst = &DX;
	sint ssrc = MAKE_INT_16(OPER_I_16());
	if(ssrc != 0)
	{
		if((UINT32)*r_dst == 0x80000000 && ssrc == -1)
		{
...
OP(m68k_op_eor_8_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(DY ^= MASK_OUT_ABOVE_8(DX));
...
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_8();
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(DX ^ m68ki_read_8(ea));
...
OP(m68k_op_eor_16_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DY ^= MASK_OUT_ABOVE_16(DX));
...
OP(m68k_op_eor_16_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DX ^ m68ki_read_16(ea));
...
OP(m68k_op_eori_8_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(DY ^= OPER_I_8());
...
OP(m68k_op_eori_16_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DY ^= OPER_I_16());
...
OP(m68k_op_eori_32_d)
{
	TEMP_UINT32 /*uint*/res = DY ^= OPER_I_32();
...
OP(m68k_op_jsr_32_pcdi)
{
	TEMP_UINT32 /*uint*/ea = EA_PCDI_32();
	m68ki_trace_t0();				   /* auto-disable (see m68kcpu.h) */
	m68ki_push_32(REG_PC);
	m68ki_jump(ea);
	RET_0_;//return;
...
OP(m68k_op_jsr_32_pcix)
{
	TEMP_UINT32 /*uint*/ea = EA_PCIX_32();
	m68ki_trace_t0();				   /* auto-disable (see m68kcpu.h) */
	m68ki_push_32(REG_PC);
	m68ki_jump(ea);
	RET_0_;//return;
...
OP(m68k_op_move_8_d_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(DY);
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_ai)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_AI_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_pi)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_PI_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_pi7)
{
	TEMP_UINT32 /*uint*/res = OPER_A7_PI_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_pd)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_PD_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_pd7)
{
	TEMP_UINT32 /*uint*/res = OPER_A7_PD_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_di)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_DI_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_ix)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_IX_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_aw)
{
	TEMP_UINT32 /*uint*/res = OPER_AW_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_al)
{
	TEMP_UINT32 /*uint*/res = OPER_AL_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_pcdi)
{
	TEMP_UINT32 /*uint*/res = OPER_PCDI_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_pcix)
{
	TEMP_UINT32 /*uint*/res = OPER_PCIX_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_d_i)
{
	TEMP_UINT32 /*uint*/res = OPER_I_8();
	uint* r_dst = &DX;
...
OP(m68k_op_move_8_ai_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/ea = EA_AX_AI_8();
...
OP(m68k_op_move_8_pi_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/ea = EA_AX_PI_8();
...
OP(m68k_op_move_8_di_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/ea = EA_AX_DI_8();
...
OP(m68k_op_move_8_ix_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/ea = EA_AX_IX_8();
...
OP(m68k_op_move_16_d_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DY);
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_a)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(AY);
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_ai)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_AI_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_pi)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_PI_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_pd)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_PD_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_di)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_DI_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_ix)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_IX_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_aw)
{
	TEMP_UINT32 /*uint*/res = OPER_AW_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_al)
{
	TEMP_UINT32 /*uint*/res = OPER_AL_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_pcdi)
{
	TEMP_UINT32 /*uint*/res = OPER_PCDI_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_pcix)
{
	TEMP_UINT32 /*uint*/res = OPER_PCIX_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_d_i)
{
	TEMP_UINT32 /*uint*/res = OPER_I_16();
	uint* r_dst = &DX;
...
OP(m68k_op_move_16_ai_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DY);
	TEMP_UINT32 /*uint*/ea = EA_AX_AI_16();
...
OP(m68k_op_move_16_pi_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DY);
	TEMP_UINT32 /*uint*/ea = EA_AX_PI_16();
...
OP(m68k_op_move_16_di_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DY);
	TEMP_UINT32 /*uint*/ea = EA_AX_DI_16();
...
OP(m68k_op_move_16_ix_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DY);
	TEMP_UINT32 /*uint*/ea = EA_AX_IX_16();
...
OP(m68k_op_move_32_d_d)
{
	TEMP_UINT32 /*uint*/res = DY;
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_a)
{
	TEMP_UINT32 /*uint*/res = AY;
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_ai)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_AI_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_pi)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_PI_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_pd)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_PD_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_di)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_DI_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_ix)
{
	TEMP_UINT32 /*uint*/res = OPER_AY_IX_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_aw)
{
	TEMP_UINT32 /*uint*/res = OPER_AW_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_al)
{
	TEMP_UINT32 /*uint*/res = OPER_AL_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_pcdi)
{
	TEMP_UINT32 /*uint*/res = OPER_PCDI_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_pcix)
{
	TEMP_UINT32 /*uint*/res = OPER_PCIX_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_d_i)
{
	TEMP_UINT32 /*uint*/res = OPER_I_32();
	uint* r_dst = &DX;
...
OP(m68k_op_move_32_ai_d)
{
	TEMP_UINT32 /*uint*/res = DY;
	TEMP_UINT32 /*uint*/ea = EA_AX_AI_32();
...
OP(m68k_op_move_32_pi_d)
{
	TEMP_UINT32 /*uint*/res = DY;
	TEMP_UINT32 /*uint*/ea = EA_AX_PI_32();
...
OP(m68k_op_move_32_di_d)
{
	TEMP_UINT32 /*uint*/res = DY;
	TEMP_UINT32 /*uint*/ea = EA_AX_DI_32();
...
OP(m68k_op_move_32_ix_d)
{
	TEMP_UINT32 /*uint*/res = DY;
	TEMP_UINT32 /*uint*/ea = EA_AX_IX_32();
...
OP(m68k_op_movem_16_re_pd)
{
	uint i = 0;
	uint register_list = OPER_I_16();
	TEMP_UINT32 /*uint*/ea = AY;
	uint count = 0;
...
OP(m68k_op_movem_16_er_pcdi)
{
	uint i = 0;
	uint register_list = OPER_I_16();
	TEMP_UINT32 /*uint*/ea = EA_PCDI_16();
	uint count = 0;
...
OP(m68k_op_movem_16_er_pcix)
{
	uint i = 0;
	uint register_list = OPER_I_16();
	TEMP_UINT32 /*uint*/ea = EA_PCIX_16();
	uint count = 0;
...
OP(m68k_op_movep_16_re)
{
	...
	#else
	m68ki_write_8(ea+2, MASK_OUT_ABOVE_8(src)); 	src >>= 8;
	m68ki_write_8(ea  , MASK_OUT_ABOVE_8(src));
	#endif
}


OP(m68k_op_movep_32_re)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_DI_32();
	TEMP_UINT32 /*uint*/src = DX;
	#if 0
	...
	m68ki_write_8(ea += 2, MASK_OUT_ABOVE_8(src));
	#else
	m68ki_write_8(ea+6, MASK_OUT_ABOVE_8(src)); 	src >>= 8;
	m68ki_write_8(ea+4, MASK_OUT_ABOVE_8(src)); 	src >>= 8;
	m68ki_write_8(ea+2, MASK_OUT_ABOVE_8(src)); 	src >>= 8;
	m68ki_write_8(ea  , MASK_OUT_ABOVE_8(src));
	#endif
}
...
OP(m68k_op_movep_32_er)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_DI_32();

	DX = (m68ki_read_8(ea	 ) << 24)
	   + (m68ki_read_8(ea + 2) << 16)
	   + (m68ki_read_8(ea + 4) <<  8)
	   + (m68ki_read_8(ea + 6)		);
	RET_0_;//return;
}
...
OP(m68k_op_moveq_32)
{
	TEMP_UINT32 /*uint*/res = DX = MAKE_INT_8(MASK_OUT_ABOVE_8(REG_IR));
...
OP(m68k_op_muls_16_d)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(DY) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_ai)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_AY_AI_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_pi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_AY_PI_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_pd)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_AY_PD_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_di)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_AY_DI_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_ix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_AY_IX_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_aw)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_AW_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_al)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_AL_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_pcdi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_PCDI_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_pcix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_PCIX_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_muls_16_i)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(MAKE_INT_16(OPER_I_16()) * MAKE_INT_16(MASK_OUT_ABOVE_16(*r_dst)));
...
OP(m68k_op_mulu_16_d)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(DY) * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_ai)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_AY_AI_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_pi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_AY_PI_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_pd)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_AY_PD_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_di)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_AY_DI_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_ix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_AY_IX_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_aw)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_AW_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_al)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_AL_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_pcdi)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_PCDI_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_pcix)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_PCIX_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_mulu_16_i)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/res = OPER_I_16() * MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_nbcd_8_d)
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(0x9a - dst - XFLAG_AS_1());
...
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = 0 - MASK_OUT_ABOVE_8(*r_dst);
...
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = 0 - MASK_OUT_ABOVE_16(*r_dst);
...
OP(m68k_op_neg_32_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_32();
	TEMP_UINT32 /*uint*/src = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = 0 - src;
...
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = 0 - MASK_OUT_ABOVE_8(*r_dst) - XFLAG_AS_1();
...
OP(m68k_op_negx_8_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_8();
	TEMP_UINT32 /*uint*/src = m68ki_read_8(ea);
	TEMP_UINT32 /*uint*/res = 0 - src - XFLAG_AS_1();
...
OP(m68k_op_negx_16_d)
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = 0 - MASK_OUT_ABOVE_16(*r_dst) - XFLAG_AS_1();
...
OP(m68k_op_negx_16_ai)
{
	TEMP_UINT32 /*uint*/ea	= EA_AY_AI_16();
	TEMP_UINT32 /*uint*/src = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = 0 - MASK_OUT_ABOVE_16(src) - XFLAG_AS_1();
...
OP(m68k_op_negx_32_d)
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = 0 - MASK_OUT_ABOVE_32(*r_dst) - XFLAG_AS_1();
...
OP(m68k_op_negx_32_ai)
{
	TEMP_UINT32 /*uint*/ea	= EA_AY_AI_32();
	TEMP_UINT32 /*uint*/src = m68ki_read_32(ea);
	TEMP_UINT32 /*uint*/res = 0 - MASK_OUT_ABOVE_32(src) - XFLAG_AS_1();
...
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(~*r_dst);
...
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_8();
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(~m68ki_read_8(ea));
...
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(~*r_dst);
...
OP(m68k_op_not_16_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(~m68ki_read_16(ea));
...
{
	uint* r_dst = &DY;
	TEMP_UINT32 /*uint*/res = *r_dst = MASK_OUT_ABOVE_32(~*r_dst);
...
OP(m68k_op_not_32_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_32();
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32(~m68ki_read_32(ea));
...
OP(m68k_op_or_8_er_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= MASK_OUT_ABOVE_8(DY)));
...
OP(m68k_op_or_8_er_ai)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_AY_AI_8()));
...
OP(m68k_op_or_8_er_pi)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_AY_PI_8()));
...
OP(m68k_op_or_8_er_pi7)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_A7_PI_8()));
...
OP(m68k_op_or_8_er_pd)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_AY_PD_8()));
...
OP(m68k_op_or_8_er_pd7)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_A7_PD_8()));
...
OP(m68k_op_or_8_er_di)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_AY_DI_8()));
...
OP(m68k_op_or_8_er_ix)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_AY_IX_8()));
...
OP(m68k_op_or_8_er_aw)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_AW_8()));
...
OP(m68k_op_or_8_er_al)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_AL_8()));
...
OP(m68k_op_or_8_er_pcdi)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_PCDI_8()));
...
OP(m68k_op_or_8_er_pcix)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_PCIX_8()));
...
OP(m68k_op_or_8_er_i)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8((DX |= OPER_I_8()));
...
OP(m68k_op_or_16_er_d)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= MASK_OUT_ABOVE_16(DY)));
...
OP(m68k_op_or_16_er_ai)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_AY_AI_16()));
...
OP(m68k_op_or_16_er_pi)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_AY_PI_16()));
...
OP(m68k_op_or_16_er_pd)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_AY_PD_16()));
...
OP(m68k_op_or_16_er_di)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_AY_DI_16()));
...
OP(m68k_op_or_16_er_ix)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_AY_IX_16()));
...
OP(m68k_op_or_16_er_aw)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_AW_16()));
...
OP(m68k_op_or_16_er_al)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_AL_16()));
...
OP(m68k_op_or_16_er_pcdi)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_PCDI_16()));
...
OP(m68k_op_or_16_er_pcix)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_PCIX_16()));
...
OP(m68k_op_or_16_er_i)
{
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16((DX |= OPER_I_16()));
...
OP(m68k_op_or_32_er_d)
{
	TEMP_UINT32 /*uint*/res = DX |= DY;
...
OP(m68k_op_or_32_er_ai)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_AY_AI_32();
...
OP(m68k_op_or_32_er_pi)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_AY_PI_32();
...
OP(m68k_op_or_32_er_pd)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_AY_PD_32();
...
OP(m68k_op_or_32_er_di)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_AY_DI_32();
...
OP(m68k_op_or_32_er_ix)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_AY_IX_32();
...
OP(m68k_op_or_32_er_aw)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_AW_32();
...
OP(m68k_op_or_32_er_al)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_AL_32();
...
OP(m68k_op_or_32_er_pcdi)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_PCDI_32();
...
OP(m68k_op_or_32_er_pcix)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_PCIX_32();
...
OP(m68k_op_or_32_er_i)
{
	TEMP_UINT32 /*uint*/res = DX |= OPER_I_32();
...
OP(m68k_op_ori_8_ai)
{
	TEMP_UINT32 /*uint*/src = OPER_I_8();
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_8();
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_8(src | m68ki_read_8(ea));
...
OP(m68k_op_ori_16_ai)
{
	TEMP_UINT32 /*uint*/src = OPER_I_16();
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(src | m68ki_read_16(ea));
...
OP(m68k_op_ror_8_s)
{
	...
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = ROR_8(src, shift);
...
OP(m68k_op_ror_16_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = ROR_16(src, shift);
...
OP(m68k_op_ror_32_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	uint/*64*/ src = *r_dst;
	TEMP_UINT32 /*uint*/res = ROR_32(src, shift);
...
OP(m68k_op_ror_16_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/src = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = ROR_16(src, 1);
...
OP(m68k_op_rol_8_s)
{
	...
	uint shift = orig_shift & 7;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = ROL_8(src, shift);
...
OP(m68k_op_rol_16_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = ROL_16(src, shift);
...
OP(m68k_op_rol_32_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	uint/*64*/ src = *r_dst;
	TEMP_UINT32 /*uint*/res = ROL_32(src, shift);
...
OP(m68k_op_rol_16_r)
{
	...
	uint shift = orig_shift & 15;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(ROL_16(src, shift));
...
#if 0
	uint* r_dst = &DY;
	const uint orig_shift = DX & 0x3f;
	const uint shift = orig_shift & 31;
	uint/*64*/ src = *r_dst;
	TEMP_UINT32 /*uint*/res = ROL_32(src, shift);
...
OP(m68k_op_rol_16_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/src = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_16(ROL_16(src, 1));
...
OP(m68k_op_roxr_8_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = ROR_9(src | (XFLAG_AS_1() << 8), shift);
...
OP(m68k_op_roxr_16_s)
{
	uint* r_dst = &DY;
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = ROR_17(src | (XFLAG_AS_1() << 16), shift);
...
OP(m68k_op_roxr_32_s)
{
	...
	uint   shift = (((REG_IR >> 9) - 1) & 7) + 1;
	uint64 src64 = *r_dst;
	uint64 res64 = src64 | (((uint64)XFLAG_AS_1()) << 32);

	if(shift != 0)
		USE_CYCLES(shift<<CYC_SHIFT);

	res64 = ROR_33_64(res64, shift);

	FLAG_C = FLAG_X = res64 >> 24;
	res64 = MASK_OUT_ABOVE_32(res64);

	*r_dst =  res64;

	FLAG_N = NFLAG_32(res64);
	FLAG_Z = res64;
	FLAG_V = VFLAG_CLEAR;
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = *r_dst;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32((ROR_33(src, shift) & ~(1 << (32 - shift))) | (XFLAG_AS_1() << (32 - shift)));
...
OP(m68k_op_roxr_16_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/src = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = ROR_17(src | (XFLAG_AS_1() << 16), 1);
...
OP(m68k_op_roxl_8_s)
{
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = ROL_9(src | (XFLAG_AS_1() << 8), shift);
...
OP(m68k_op_roxl_16_s)
{
	uint* r_dst = &DY;
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_16(*r_dst);
	TEMP_UINT32 /*uint*/res = ROL_17(src | (XFLAG_AS_1() << 16), shift);
...
OP(m68k_op_roxl_32_s)
{
	...
	*r_dst = res64;
	...
	uint shift = (((REG_IR >> 9) - 1) & 7) + 1;
	TEMP_UINT32 /*uint*/src = *r_dst;
	TEMP_UINT32 /*uint*/res = MASK_OUT_ABOVE_32((ROL_33(src, shift) & ~(1 << (shift - 1))) | (XFLAG_AS_1() << (shift - 1)));
...
OP(m68k_op_roxl_16_ai)
{
	TEMP_UINT32 /*uint*/ea = EA_AY_AI_16();
	TEMP_UINT32 /*uint*/src = m68ki_read_16(ea);
	TEMP_UINT32 /*uint*/res = ROL_17(src | (XFLAG_AS_1() << 16), 1);
...
OP(m68k_op_sbcd_8_rr)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = DY;
	TEMP_UINT32 /*uint*/dst = *r_dst;
	TEMP_UINT32 /*uint*/res = LOW_NIBBLE(dst) - LOW_NIBBLE(src) - XFLAG_AS_1();
...
OP(m68k_op_subx_8_rr)
{
	uint* r_dst = &DX;
	TEMP_UINT32 /*uint*/src = MASK_OUT_ABOVE_8(DY);
	TEMP_UINT32 /*uint*/dst = MASK_OUT_ABOVE_8(*r_dst);
	TEMP_UINT32 /*uint*/res = dst - src - XFLAG_AS_1();
...
#if (OPT_ON==M68K_TAS_HAS_CALLBACK)
...
#else
	#if (OPT_ON==M68K_TAS_DO_SET)
	m68ki_write_8(ea, dst | 0x80);
	#endif // (OPT_ON==M68K_TAS_DO_SET)
#endif // (OPT_ON==M68K_TAS_HAS_CALLBACK)
	RET_0_;//return;
}
...
/* ======================================================================== */
/* ==== AUTO GENERATED ========== END OF OPS CODE ========================= */
/* ======================================================================== */
...
static void/*test*/ (*m68ki_instruction_jump_table[0x10000])(void) PSP_ALIGN_DATA ; /* opcode handler jump table */
